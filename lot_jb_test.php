<?php
	...
	require ("includes_ga_jb/calculate_draw.php");
	...
	function test_nums($limit)
	{
		...
		while($row = mysqli_fetch_array($mysqli_result))
		{
			...
			{
				$query7 = "SELECT * FROM combo_5_$balls_";
				$query7 .= "$balls_draws_";
				$query7 .= "$hml_temp ";
				$query7 .= "WHERE b1 = '$row[1]' ";
				$query7 .= "AND   b2 = '$row[2]' ";
			...
			$draw_count = calculate_draw_count_jb($draw); 
	...
	$last_date = test_combin_print_sum(100); 
