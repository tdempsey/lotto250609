<?php
	...
	$query2 = "SELECT DISTINCT date, d1, d2, combo, combo_count, hml FROM ga_f5_2_39 ";
	...
	while($row2 = mysqli_fetch_array($mysqli_result2))
	{
		...
		if ($num_rows > 1)
		{
			echo "dup = $row[date],$row[d1],$row[d2],$row[hml]<p>";

			while($row = mysqli_fetch_array($mysqli_result))
			{
				$query5 = "DELETE FROM ga_f5_2_39 ";
			...
			$query_update = "UPDATE ga_f5_2_39 ";
