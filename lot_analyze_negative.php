<?php
	...
	echo "<b>col1 = $col1 in lot_display.php</b><p>";
	...
	{
		global $draw_table_name, $balls, $balls_drawn, $game_includes, $draw_prefix, $game_includes, $hml, $range_low, $range_high, $col1; 
		...
		while($row = mysqli_fetch_array($mysqli_result))
		{
			...
			*/
			...
			if ($game == 10 OR $game == 20)
			{
				$rank_count = BuildRankTable($row[id]);
			...
			if ($num_range_d501 == 0 || $num_range_d501 >= $balls_drawn) {
			...
			for($x = 0; $x <= 20; $x++)
			{
				...
				if ($draw_rank_count[$x] > 2) {
					printf("<TD><CENTER><font color=\"#ff0000\"><B>$draw_rank_count[$x]/$rank_table_count[$x]</B><br><center><font size=\"-1\">%1.2f</font></center></font></CENTER></TD>\n",$temp_rank);
				} else {
					printf("<TD><CENTER>$draw_rank_count[$x]/$rank_table_count[$x]<br><center><font size=\"-1\">%1.2f</font></center></CENTER></TD>\n",$temp_rank);
				}
			}
	...
	{
		global $draw_table_name, $balls, $balls_drawn, $draw_prefix, $col1; 
	...
	while($row = mysqli_fetch_array($mysqli_result))
	{
		...
		print("<TR>\n");
		print("<TD width=\"100\"><center>04 - D501</center></TD>\n");
		print("<TD width=\"50\"><center>$row_temp[low]</center></TD>\n");
		print("<TD width=\"50\"><center>$row_temp[high]</center></TD>\n");
		print("<TD width=\"50\"><center>$row[d501]</center></TD>\n");
		if ($row[d501] >= $row_temp[low] && $row[d501] <= $row_temp[high])
		{
			print("<TD width=\"50\" BGCOLOR=\"#00dd00\"><center><font color=\"#ffffff\"><b>Pass</b></font></center></TD>\n");
			print("<TD width=\"50\"><center>---</center></TD>\n");
		} else {
		...
		print("<TR>\n");
		print("<TD width=\"100\"><center>05 - D502</center></TD>\n");
		print("<TD width=\"50\"><center>$row_temp[low]</center></TD>\n");
		print("<TD width=\"50\"><center>$row_temp[high]</center></TD>\n");
		print("<TD width=\"50\"><center>$row[d502]</center></TD>\n");
		if ($row[d502] >= $row_temp[low] && $row[d502] <= $row_temp[high])
		{
			print("<TD width=\"50\" BGCOLOR=\"#00dd00\"><center><font color=\"#ffffff\"><b>Pass</b></font></center></TD>\n");
			print("<TD width=\"50\"><center>---</center></TD>\n");
		} else {
