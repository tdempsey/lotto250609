<?php
	...
	require ("includes/display3.php");
	require ("includes/display3_summary.php");
	...
	print("<HTML>\n");
	print("<HEAD>\n");
	print("<TITLE>$game_name Display 3 - $game_name</TITLE>\n");
	print("</HEAD>\n");
	...
	#{
		...
		lot_display3 ($dateDiff,$combin=1);
		
		lot_display3 ($dateDiff,$combin=2);

		lot_display3 ($dateDiff,$combin=3);

		lot_display3 ($dateDiff,$combin=4);

		echo "enter lot_display3 ($dateDiff,$combin=5)<br>";
		
		lot_display3 ($dateDiff,$combin=5);

		lot_display3 ($dateDiff,$combin=6);
		
		lot_display3 ($dateDiff,$combin=7);

		lot_display3 ($dateDiff,$combin=8);

		lot_display3 ($dateDiff,$combin=9);

		lot_display3 ($dateDiff,$combin=10);

		lot_display3_summary ($dateDiff);
	#}
