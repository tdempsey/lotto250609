<?php
	...
	function print_sum_grid_sum2_sumeo($combin,$sumeo_sum,$sumeo_even,$sumeo_odd)
	{
		...
		echo "<h3>calculate_sum_count_sum2_sumeo >>> lot_sumeo_get</h3>";	###240622
	...
	print "<h2>*** SumEO = $sum,$even,$odd - sumeo $sumeo</h2>";
	...
	*/
	...
	for ($col = 1; $col <= 5; $col++)
	{
		echo "<h3>print_column_test_sumeo</h3>";
