<?php
	...
	function update_counts($count,$draw_date) 
	{
		...
		{
			$d_array = array($row2[2],$row2[3],$row2[4],$row2[5]);
	...
	update_counts(4,'2022-10-1');

	update_counts_hml(4,'2022-10-1');

	update_counts_hml_sum(4,'2022-10-1');

	#update_even_odd(4,'2022-10-1');
