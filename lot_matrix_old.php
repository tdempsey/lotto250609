<?php
	...
	function lot_matrix ($col1,$dup1,$limit,$delete_temp)
	{ 
		...
		*/
		...
		for ($m = 1; $m <= $limit; $m++)
		{
					...
					for ($b = 0; $b <= 4; $b++)
					{
						if (${row.$a}[$b] == 1)
						{
							do {
								...
								$passed = DrawSeed1($col1=$col1_table[$rand_id],$dup1);
								if ($passed)
								{
			...
			#$matrix[2][2] = $max_array[$rand_id]; # temp
	...
	lot_matrix ($col1=0,$dup1=0,$limit=1,$delete_temp=0);
