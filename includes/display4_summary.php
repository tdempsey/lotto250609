<?php
	function lot_display4_summary ($limit)
	{ 
		...
		if (1)
		{
			...
			# all
			$table_temp_summary = $draw_prefix . "temp2a_4_summary_" . $limit; 
			...
			print("<h2>Summary Combin 4 - Numbers Sorted By percent_wa - Limit $limit</h2>\n");
			print("<P>");
			...
			print("<h2>Summary Combin 4 - Numbers Sorted By month6 - Limit $limit</h2>\n");
			print("<P>");
			#echo "table_temp = $table_temp<p>";
			print("<TABLE BORDER=\"1\">\n");
			...
			while($row_combin = mysqli_fetch_array($mysqli_result_combin))
			{
				...
				for ($d = 3; $d <= 16; $d++)
				{
					...
					{
						print("<TD bgcolor=\"#FF0033\" align=center>{$row_combin[$d]}</TD>\n");
					} elseif ($row_combin[$d] > 200) {
						print("<TD bgcolor=\"#FF9900\" align=center>{$row_combin[$d]}</TD>\n");
					} elseif ($row_combin[$d] > 100) {
						print("<TD bgcolor=\"#FFDD33\" align=center>{$row_combin[$d]}</TD>\n");
					} elseif ($row_combin[$d] >= 50) {
						print("<TD bgcolor=\"#66CC00\" align=center>{$row_combin[$d]}</TD>\n");
					} elseif ($row_combin[$d] >= 10) {
						print("<TD bgcolor=\"#33CC00\" align=center>{$row_combin[$d]}</TD>\n");
					} else {
						print("<TD bgcolor=\"#87CEFF\" align=center>{$row_combin[$d]}</TD>\n");
					}
				} 
