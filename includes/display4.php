<?php
	function lot_display4 ($limit,$combin)
	{ 
		...
		if (1)
		{
			...
			// get from draw table
			// get from draw table
			$query5 = "SELECT * FROM ga_f5_4_42 ";	### 220113
			$query5 .= "WHERE combo = $combin ";
			...
			{	
				...
				if ($row[9] == 0)
				{
					...
					#require ("includes_ga_f5/update_even_odd4.incl"); #200908
			...
			while($row = mysqli_fetch_array($mysqli_result5))
			{
				...
				##############################################################
				#echo "### 4 - calculate_draw_count4.inc ###<br>";
			...
			require ("includes_ga_f5/draw_count_table_4.incl"); #fix 1911
			##############################################################################
			
			// process and print unsorted table

			#echo "### /unsorted_table_large_4.incl ###<br>";
			
			if ($limit > 105)
			{
				require ("includes_ga_f5/unsorted_table_large_4.incl");
				#require ("includes/unsorted_table_1510.incl");
			} elseif ($limit == 100) {
				require ("includes_ga_f5/unsorted_table_100_4.incl");
			} else {
				require ("includes_ga_f5/unsorted_table_4.incl");
			}
			...
			##############################################################
			#echo "### sorted_table_large_4.incl ###<br>";
			
			if ($limit > 105 )
			{
				require ("includes_ga_f5/sorted_table_large_4.incl");
			} elseif ($limit == 100) {
				require ("includes_ga_f5/sorted_table_100_4.incl");
			} else {
				require ("includes_ga_f5/sorted_table_4.incl");
			}
