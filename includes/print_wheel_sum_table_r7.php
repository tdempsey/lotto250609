<?php
function print_wheel_sum_table_r7($limit)
{
	...
	$query4 .= "`r7_1` tinyint(3) unsigned NOT NULL,";
	$query4 .= "`r7_2` tinyint(3) unsigned NOT NULL,";
	$query4 .= "`r7_3` tinyint(3) unsigned NOT NULL,";
	$query4 .= "`r7_4` tinyint(3) unsigned NOT NULL,";
	$query4 .= "`r7_5` tinyint(3) unsigned NOT NULL,";
	$query4 .= "`r7_6` tinyint(3) unsigned NOT NULL,";
	$query4 .= "`r7_7` tinyint(3) unsigned NOT NULL,";
	...
	$query_eo50 = "SELECT DISTINCT a.even, a.odd, b.d1, b.d2, b.d3, b.d4, b.d5, b.d6, b.d7 FROM ";
	$query_eo50 .= "$draw_table_name a ";
	$query_eo50 .= "JOIN ga_f5_draw_range7 ";
	$query_eo50 .= "b ON ";
	$query_eo50 .= "a.date = b.date ";
	$query_eo50 .= "ORDER BY a.even, a.odd, b.d1 ASC, b.d2 ASC, b.d3 ASC, b.d4, b.d5, b.d6, b.d7 ASC ";
	...
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_1</TD>\n");
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_2</TD>\n");
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_3</TD>\n");
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_4</TD>\n");
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_5</TD>\n");
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_6</TD>\n");
	print("<TD BGCOLOR=\"#CCCCCC\" align=\"center\">r7_7</TD>\n");
	...
	for ($w = $low; $w <= $high; $w++)
	{
		...
		while($row_eo50 = mysqli_fetch_array($mysqli_result_eo50))
		{
				...
				$query_draw = "SELECT a.date, a.sum, a.even, a.odd, b.d1, b.d2, b.d3, b.d4, b.d5, b.d6, b.d7 FROM ";
				$query_draw .= "$draw_table_name a ";
				$query_draw .= "JOIN ga_f5_draw_range7 ";
				$query_draw .= "b ON ";
				...
				$query_draw .= "AND d7 = $row_eo50[d7] ";
				$query_draw .= "ORDER BY a.date,a.even, a.odd, b.d1 ASC, b.d2 ASC, b.d3 ASC, b.d4, b.d5 ASC, b.d6 ASC, b.d7 ASC ";
				...
				if ($game == 1 || $game == 4 || $game == 5)
				{
					...
					if ($game == 1)
					{
						$query_rows .= "AND r7_1 = $row_eo50[d1] ";
						$query_rows .= "AND r7_2 = $row_eo50[d2] ";
						$query_rows .= "AND r7_3 = $row_eo50[d3] ";
						$query_rows .= "AND r7_4 = $row_eo50[d4] ";
						$query_rows .= "AND r7_5 = $row_eo50[d5] ";
					} else {
				...
				#if ($num_rows_all_draw && $sum_count_array[16] > 0) #151014
				#if ($num_rows) #151014
				...
				if ($num_rows_all_draw && $sum_count_array[11] > 1 && $sum_count_array[16] > 1)
				{
					...
					print("<TD align=center><center>$row_eo50[d7]</center></TD>\n");
					...
					$query_date .= "AND r7_1 = $row_eo50[d1] ";
					$query_date .= "AND r7_2 = $row_eo50[d2] ";
					$query_date .= "AND r7_3 = $row_eo50[d3] ";
					$query_date .= "AND r7_4 = $row_eo50[d4] ";
					$query_date .= "AND r7_5 = $row_eo50[d5] ";
					$query_date .= "AND r7_6 = $row_eo50[d6] ";
					$query_date .= "AND r7_6 = $row_eo50[d7] ";
	...
	print "<h3>Table <font color=\"#ff0000\">{$draw_prefix}wheel_sum_table_r7</font> Updated!</h3>";

	# copy current table into dated table
	$curr_date = date("ymd");

	$table_temp_date = $draw_prefix . 'wheel_sum_table_r7_' . $curr_date;
