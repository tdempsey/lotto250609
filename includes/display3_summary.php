<?php
	function lot_display3_summary ($limit)
	{ 
		...
		if (1)
		{
			...
			# all
			$table_temp_summary = $draw_prefix . "temp2a_3_summary_" . $limit; 
			...
			{
				$table_temp = $draw_prefix . "temp2a_3_" . $combin . "_" . $limit; 
			...
			print("<h2>Summary Combin 3 - Numbers Sorted By percent_wa - Limit $limit</h2>\n");
			print("<P>");
