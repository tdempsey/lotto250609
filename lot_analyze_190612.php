<?php
	...
	function print_sum_grid_old()
	{
		...
		for ($x = 1; $x <= 28; $x++)
		{
			...
			if ($sum_temp_30 >= 10.0)
			{
				print("<TD align=center><font color=\"#ff0000\"><b>$sum_temp_30 %</b></font></TD>\n");
			} else {
				print("<TD align=center><font color=\"#ff0000\">$sum_temp_30 %</font></TD>\n");
			}

			$sum_temp_365 = number_format(($sum_tot_365[$x]/365)*100,1);
			if ($sum_temp_365 >= 10.0)
			{
				print("<TD align=center><font color=\"#ff0000\"><b>$sum_temp_365 %</b></font></TD>\n");
			} else {
				print("<TD align=center><font color=\"#ff0000\">$sum_temp_365 %</font></TD>\n");
			}

			$sum_temp_5000 = number_format(($sum_tot_5000[$x]/$num_rows_all)*100,1);
			if ($sum_temp_5000 >= 10.0)
			{
				print("<TD align=center><font color=\"#ff0000\"><b>$sum_temp_5000 %</b></font></TD>\n");
			} else {
				print("<TD align=center><font color=\"#ff0000\">$sum_temp_5000 %</font></TD>\n");
			}
			...
			if ($sum_temp_wa >= 10.0)
			{
				print("<TD align=center><font color=\"#ff0000\"><b>$sum_temp_wa %</b></font></TD>\n");
			} else {
				print("<TD align=center><font color=\"#ff0000\">$sum_temp_wa %</font></TD>\n");
			}
