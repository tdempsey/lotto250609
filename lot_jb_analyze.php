<?php
	...
	function print_table($limit)
	{
		...
		while($row = mysqli_fetch_array($mysqli_result))
		{
			...
			*/
			...
			if ($row[7] < $sum_low || $row[7] > $sum_high)
			{
				print("<TD align=center><font color=\"#ff0000\"><b>$row[7]</b></font></TD>\n");
			} else {
	...
	function print_sum_grid_sum()
	{
		...
		require ("includes_ga_jb/calculate_sum_count_sum.incl");

		require ("includes_ga_jb/print_sum_table_sum.incl");

		require ("includes_ga_jb/print_sum_table_sum_top25.incl");
