<?php
	...
	#require ("includes_fl_f5/calc_matrix_filters.incl");
		...
		*/
		...
		for ($m = 1; $m <= $limit; $m++)
		{
			...
			if ($num_rows_r0)
			{
				...
				require ("includes_fl_f5/matrix_3a.incl");
			}
				...
				do 
				{
					if ($row0 = mysqli_fetch_array($mysqli_result_r0))
					{
						...
						if ($pass_pairs)
						{
							...
							echo "failed - $row0[b1] - $row0[b2] - $row0[b3] - $row0[b4]- $row0[b5]<p>";
							#require ("includes_fl_f5/matrix_4a.incl");
						}
					} else {
						...
						if ($num_rows_r0)
						{
							...
							do 
							{
								if ($row0 = mysqli_fetch_array($mysqli_result_r0))
								{
									...
									require ("includes_fl_f5/matrix_5a.incl");
								}
							} while (!$pass_pairs);
			...
			if ($num_rows_r0)
			{
				...
				do 
				{
					if ($row0 = mysqli_fetch_array($mysqli_result_r0))
					{
						...
						require ("includes_fl_f5/matrix_6a.incl");
					}
				} while (!$pass_pairs);
			...
			if ($num_rows_r0)
			{
				...
				do 
				{
					if ($row0 = mysqli_fetch_array($mysqli_result_r0))
					{
						...
						require ("includes_fl_f5/matrix_7a.incl");
					}
				} while (!$pass_pairs);
			...
			if ($num_rows_r0)
			{
				...
				do 
				{
					if ($row0 = mysqli_fetch_array($mysqli_result_r0))
					{
						...
						require ("includes_fl_f5/matrix_8a.incl");
					}
				} while (!$pass_pairs);
