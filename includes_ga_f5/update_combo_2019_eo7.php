<?php
	function update_combo_2019_eo7($sum,$even,$odd,$d7_1,$d7_2,$d7_3,$d7_4,$d7_5,$d7_6,$d7_7)
	{
		...
		*/
		...
		$query_ct .= "JOIN combo_5_42_dr7 b ";
		...
		$query_ct .= "AND   b.d1 = $d7_1 ";
		$query_ct .= "AND   b.d2 = $d7_2 ";
		$query_ct .= "AND   b.d3 = $d7_3 ";
		$query_ct .= "AND   b.d4 = $d7_4 ";
		$query_ct .= "AND   b.d5 = $d7_5 ";
		$query_ct .= "AND   b.d6 = $d7_6 ";
		$query_ct .= "AND   b.d7 = $d7_7 ";
		$query_ct .= "AND seq2 <= 1 ";
		...
		while($row = mysqli_fetch_array($mysqli_result_ct))
		{
			...
			$query_eo50 .= "AND   d7_1 = $row[d7_1] ";
			$query_eo50 .= "AND   d7_2 = $row[d7_2] ";
			$query_eo50 .= "AND   d7_3 = $row[d7_3] ";
			$query_eo50 .= "AND   d7_4 = $row[d7_4] ";
			$query_eo50 .= "AND   d7_5 = $row[d7_5] ";
			$query_eo50 .= "AND   d7_6 = $row[d7_6] ";
			$query_eo50 .= "AND   d7_7 = $row[d7_7] ";
