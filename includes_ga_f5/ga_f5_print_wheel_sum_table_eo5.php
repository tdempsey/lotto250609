<?php
	function ga_f5_print_wheel_sum_table_eo5($limit)
	{
		...
		$query4 .= "`eo50` tinyint(3) unsigned NOT NULL default '0',";
...
$query4 .= "year3 tinyint(3) unsigned NOT NULL default '0', ";
		...
		for ($w = $low; $w <= $high; $w++)
		{
			$query_eo50 = "SELECT DISTINCT a.even, a.odd, b.d1, b.d2, b.d3, b.d4, b.d5 FROM $draw_table_name a ";
			$query_eo50 .= "JOIN $draw_prefix";
			$query_eo50 .= "draws_draw5 b "; #change when building
			$query_eo50 .= "ON a.date = b.date ";
			$query_eo50 .= "WHERE a.even > 0 ";
			$query_eo50 .= "AND   a.even < 5 ";
			$query_eo50 .= "ORDER BY b.d1 ASC, b.d2 ASC, b.d3 ASC, b.d4, b.d5 ASC ";

			#print "<h3>$query_eo50</h3><p>";
		
			$mysqli_result_eo50 = mysqli_query($mysqli_link, $query_eo50) or die (mysqli_error($mysqli_link));
			...
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d5_1</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d5_2</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d5_3</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d5_4</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d5_5</TD>\n";
			...
			if ($first_draw_unix > $year7_unix) {
				...
				$query_rows = "SELECT count(*) FROM combo_5_42_dr5 ";
				...
				if ($sum_count_array[16] > 1) #180903
				{
					...
					$query_date .= "AND d5_1 = $row_eo50[d1] ";
					$query_date .= "AND d5_2 = $row_eo50[d2] ";
					$query_date .= "AND d5_3 = $row_eo50[d3] ";
					$query_date .= "AND d5_4 = $row_eo50[d4] ";
					$query_date .= "AND d5_5 = $row_eo50[d5] ";
		...
		print "<h3>Table <font color=\"#ff0000\">{$draw_prefix}wheel_sum_table_eo5</font> Updated!</h3>";

		# copy current table into dated table
		$curr_date = date("ymd");

		$table_temp_date = $draw_prefix . 'wheel_sum_table_eo5_' . $curr_date;
		...
		$query_copy .= "wheel_sum_table_eo5 ";
