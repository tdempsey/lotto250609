<?php
	function ga_f5_print_wheel_sum_table_eo7($limit)
	{
		...
		$query4 .= "`sum` int(3) unsigned NOT NULL  default '0',";
		$query4 .= "`sum_count` int(6) unsigned NOT NULL default '0',";
		$query4 .= "`eo60` tinyint(3) unsigned NOT NULL default '0',";
		...
		$query4 .= "`d5` tinyint(3) unsigned NOT NULL,";
		$query4 .= "`d6` tinyint(3) unsigned NOT NULL,";
		$query4 .= "`d7` tinyint(3) unsigned NOT NULL,";
...
$query4 .= "d1510 tinyint(3) unsigned NOT NULL default '0', ";
		...
		$query_eo70 = "SELECT DISTINCT a.even, a.odd, b.d1, b.d2, b.d3, b.d4, b.d5, b.d6, b.d7 FROM $draw_table_name a ";
		$query_eo70 .= "JOIN $draw_prefix";
		$query_eo70 .= "draws_draw7 b "; #change when building
		$query_eo70 .= "ON a.date = b.date ";
		$query_eo70 .= "WHERE a.even > 0 ";
		$query_eo70 .= "AND   a.even < 5 ";
		$query_eo70 .= "ORDER BY b.d1 ASC, b.d2 ASC, b.d3 ASC, b.d4, b.d5, b.d6, b.d7 ASC ";

		#print "<h3>$query_eo70</h3><p>";
	
		$mysqli_result_eo70 = mysqli_query($mysqli_link, $query_eo70) or die (mysqli_error($mysqli_link));
		...
		for ($w = $low; $w <= $high; $w++)
		{
			...
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">eo60</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">Even</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">Odd</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_1</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_2</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_3</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_4</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_5</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_6</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d7_7</TD>\n";
			...
			while($row_eo70 = mysqli_fetch_array($mysqli_result_eo70))
			{					
				$sum_count_array = array_fill (0,17,0);

				$query_draw = "SELECT * FROM $draw_table_name a ";
				$query_draw .= "JOIN $draw_prefix";
				$query_draw .= "draws_draw7 b "; #change when building
				$query_draw .= "ON a.date = b.date ";
				$query_draw .= "AND a.even = $row_eo70[even] ";
				$query_draw .= "AND a.odd  = $row_eo70[odd] ";
				$query_draw .= "AND b.d1 = $row_eo70[d1] ";
				$query_draw .= "AND b.d2 = $row_eo70[d2] ";
				$query_draw .= "AND b.d3 = $row_eo70[d3] ";
				$query_draw .= "AND b.d4 = $row_eo70[d4] ";
				$query_draw .= "AND b.d5 = $row_eo70[d5] ";
				$query_draw .= "AND b.d6 = $row_eo70[d6] ";
				$query_draw .= "AND b.d7 = $row_eo70[d7] ";
				$query_draw .= "WHERE a.sum = $w ";
				$query_date .= "date <= '2015-10-01' ";
			...
			if ($first_draw_unix > $year7_unix) {
				...
				$query_rows = "SELECT count(*) FROM combo_5_42_dr7 ";
				...
				$query_rows .= "AND d5 = $row_draw[d5] ";
				$query_rows .= "AND d6 = $row_draw[d6] ";
				$query_rows .= "AND d7 = $row_draw[d7] ";
				...
				if ($sum_count_array[16] > 1) #180903
				{
					...
					print("<TD align=center><center>$row_eo70[id]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[even]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[odd]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d1]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d2]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d3]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d4]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d5]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d6]</center></TD>\n");
					print("<TD align=center><center>$row_eo70[d7]</center></TD>\n");
					...
					$query_date .= "AND even = $row_eo70[even] ";
					$query_date .= "AND odd = $row_eo70[odd] ";
					$query_date .= "AND d7_1 = $row_eo70[d1] ";
					$query_date .= "AND d7_2 = $row_eo70[d2] ";
					$query_date .= "AND d7_3 = $row_eo70[d3] ";
					$query_date .= "AND d7_4 = $row_eo70[d4] ";
					$query_date .= "AND d7_5 = $row_eo70[d5] ";
					$query_date .= "AND d7_6 = $row_eo70[d6] ";
					$query_date .= "AND d7_7 = $row_eo70[d7] ";
					$query_date .= "date <= '2015-10-01' ";
					...
					$sum_temp_6m = number_format(($sum_count_array[5]/180)*100,1);
		...
		print "<h3>Table <font color=\"#ff0000\">{$draw_prefix}wheel_sum_table_eo7</font> Updated!</h3>";

		# copy current table into dated table
		$curr_date = date("ymd");

		$table_temp_date = $draw_prefix . 'wheel_sum_table_eo7_' . $curr_date;
		...
		$query_copy .= "wheel_sum_table_eo7 ";
