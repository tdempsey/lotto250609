<?php
	function ga_f5_print_wheel_sum_table_eo3($limit)
	{
		...
		$query4 .= "`eo30` tinyint(3) unsigned NOT NULL default '0',";
		...
		for ($w = $low; $w <= $high; $w++)
		{
			$query_eo30 = "SELECT DISTINCT a.even, a.odd, b.d1, b.d2, b.d3  FROM $draw_table_name a ";
			$query_eo30 .= "JOIN $draw_prefix";
			$query_eo30 .= "draws_draw3 b "; #change when building ***
			$query_eo30 .= "ON a.date = b.date ";
			$query_eo30 .= "WHERE a.even > 0 ";
			$query_eo30 .= "AND   a.even < 5 ";
			$query_eo30 .= "ORDER BY b.d1 ASC, b.d2 ASC, b.d3 ASC ";

			#print "<h3>$query_eo30</h3><p>";
		
			$mysqli_result_eo30 = mysqli_query($mysqli_link, $query_eo30) or die (mysqli_error($mysqli_link));

			print "<TR>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">Sum</TD>\n";
			print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">eo30</TD>\n";
			...
			while($row_eo30 = mysqli_fetch_array($mysqli_result_eo30))
			{					
				$sum_count_array = array_fill (0,17,0);

				$query_draw = "SELECT * FROM $draw_table_name a ";
				$query_draw .= "JOIN $draw_prefix";
				$query_draw .= "draws_draw3 b "; #***
				$query_draw .= "ON a.date = b.date ";
				$query_draw .= "AND a.even = $row_eo30[even] ";
				$query_draw .= "AND a.odd  = $row_eo30[odd] ";
				$query_draw .= "AND b.d1 = $row_eo30[d1] ";
				$query_draw .= "AND b.d2 = $row_eo30[d2] ";
				$query_draw .= "AND b.d3 = $row_eo30[d3] ";
				#$query_draw .= "AND b.d4 = $row_eo30[d4] ";
...
$query_draw .= "AND a.date >= '2015-10-01' ";
			...
			if ($first_draw_unix > $year7_unix) {
				...
				$query_rows = "SELECT count(*) FROM combo_5_42_dr3 "; #***
				...
				if ($sum_count_array[16] > 1) #180903
				{
					...
					print("<TD align=center><center>$row_eo30[id]</center></TD>\n");
					print("<TD align=center><center>$row_eo30[even]</center></TD>\n");
					print("<TD align=center><center>$row_eo30[odd]</center></TD>\n");
					print("<TD align=center><center>$row_eo30[d1]</center></TD>\n");
					print("<TD align=center><center>$row_eo30[d2]</center></TD>\n");
					print("<TD align=center><center>$row_eo30[d3]</center></TD>\n");
					#print("<TD align=center><center>$row_eo30[d4]</center></TD>\n");
					...
					$query_date .= "AND even = $row_eo30[even] ";
					$query_date .= "AND odd = $row_eo30[odd] ";
					$query_date .= "AND d3_1 = $row_eo30[d1] ";
					$query_date .= "AND d3_2 = $row_eo30[d2] ";
					$query_date .= "AND d3_3 = $row_eo30[d3] ";
					#$query_date .= "AND d3_4 = $row_eo30[d4] ";
					...
					if ($row_count_break == 23)
					{
						...
						print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d3_2</TD>\n";
						print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d3_3</TD>\n";
						#print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">d3_4</TD>\n";
						print "<TD BGCOLOR=\"#CCCCCC\" align=\"center\">Rows</TD>\n";
						print "<TD BGCOLOR=\"#CCCCCC\"><center>Last</center></TD>\n";
						print "<TD BGCOLOR=\"#CCCCCC\"><center>Week1</center></TD>\n";
						print "<TD BGCOLOR=\"#CCCCCC\"><center>Week2</center></TD>\n";
		...
		$table_temp_date = $draw_prefix . 'wheel_sum_table_eo3_' . $curr_date;
		...
		$query_copy .= "wheel_sum_table_eo3 ";
