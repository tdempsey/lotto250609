<?php
	function update_combo_2019_eo5($sum,$even,$odd,$d5_1,$d5_2,$d5_3,$d5_4,$d5_5)
	{
		...
		*/
		...
		$query_ct .= "JOIN combo_5_42_dr5 b ";
		...
		$query_ct .= "AND   b.d1 = $d5_1 ";
		$query_ct .= "AND   b.d2 = $d5_2 ";
		$query_ct .= "AND   b.d3 = $d5_3 ";
		$query_ct .= "AND   b.d4 = $d5_4 ";
		$query_ct .= "AND   b.d5 = $d5_5 ";
		$query_ct .= "AND seq2 <= 1 ";
		...
		while($row = mysqli_fetch_array($mysqli_result_ct))
		{
			...
			$query_eo50 .= "AND   d5_1 = $row[d5_1] ";
			$query_eo50 .= "AND   d5_2 = $row[d5_2] ";
			$query_eo50 .= "AND   d5_3 = $row[d5_3] ";
			$query_eo50 .= "AND   d5_4 = $row[d5_4] ";
			$query_eo50 .= "AND   d5_5 = $row[d5_5] ";
