<?php
	// ----------------------------------------------------------------------------------
	function split_sumeo_4_range($sum,$sum_even,$sum_odd)
	{
		...
		$sumeo_table = 'temp_5_' . $balls . '_' . $sum . '_' . $sum_even . '_' . $sum_odd;

		$table_temp = 'temp_4_' . $balls . '_' . $sum . '_' . $sum_even . '_' . $sum_odd;
