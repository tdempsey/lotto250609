<?php
	...
	function DrawNumbersLM7()
	{ 
		global 	$debug,$combo,$sorted_nums,$next_draw_Ymd,$balls_drawn;
		...
		*/
		...
		{
			exit("<h2>Error - function draw_numbers_filter.php - <font color=\"#FF0000\">parameter undefined - next_draw_Ymd = $next_draw_Ymd</font></h2>");
		}
		// error checking ----------------------------------------------------------------------------------------------

		log_info("--- DrawNumbersLM7()\n");
		...
		log_info("------ DrawNumbers() $sorted_nums[0],$sorted_nums[1],$sorted_nums[2],$sorted_nums[3],$sorted_nums[4]\n");
		
		$draw_status = TestPicksLM7();
