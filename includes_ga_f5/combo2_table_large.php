<?php
	...
	print("<H2>Combo 2 - position $combo_pos - $game_name - Limit $limit</H2>\n");
	...
	for ($x = 1; $x <= $balls; $x++)
	{
		for ($y = 1; $y <= $balls; $y++)
		{
			if ($x <> $y)
			{
				...
				$query5 .= "WHERE num1 = $x AND num2 = $y and combo = $combo_pos "; 
				...
				$query_last .= "WHERE num1 = $x AND num2 = $y and combo = $combo_pos ";  
