<?php
	// ----------------------------------------------------------------------------------
	function split_sumeo_2_m2($sum,$sum_even,$sum_odd)
	{
		...
		$table_temp = 'combo_2_' . $balls . '_' . $sum . '_' . $sum_even . '_' . $sum_odd . '_m2';
