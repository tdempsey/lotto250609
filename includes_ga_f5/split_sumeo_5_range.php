<?php
	// ----------------------------------------------------------------------------------
	function split_sumeo_5_range($sum,$even,$odd)
	{
		...
		$table_temp1 = 'temp_filter_' . $balls_drawn . '_' . $balls . '_' . $sum . '_' . $even . '_' . $odd . '_nofilter';
		...
		*/
		...
		$table_temp1 = 'temp_filter_' . $balls_drawn . '_' . $balls . '_' . $sum . '_' . $even . '_' . $odd;
		...
		*/
		...
		$table_temp2 = 'temp_5_' . $balls_drawn . '_' . $balls . '_' . $sum . '_' . $even . '_' . $odd;
		...
		$query_drange4 = "SELECT * FROM `ga_f5_sumeo_drange4` WHERE sum = $sum AND even = $even AND odd = $odd AND percent_wa > 0.10 ORDER BY `ga_f5_sumeo_drange4`.`percent_wa` DESC ";
		...
		while($row = mysqli_fetch_array($mysqli_result))
		{
			if (1) #25
			{
				...
				$query5 = "INSERT INTO $table_temp3 (`id`, `b1`, `c2`, `count`, `y1_sum`) VALUES (0, '$row[b1]', '$row[b2]', '$row[2]', '$y1_sum'); ";
		...
		$query .= "ORDER BY c1 ASC, y1_sum DESC ";
