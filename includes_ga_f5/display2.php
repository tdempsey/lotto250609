<?php
	...
	{ 
		...
		if (1)
		{
			...
			require ("includes_pb/display2nav.incl");
			...
			{	
				...
				if ($row[9] == 0)
				{
					...
					require ("includes_pb/update_even_odd2.incl");
			...
			while($row = mysqli_fetch_array($mysqli_result5))
			{
				...
				require ("includes/calculate_draw_count2.incl"); #ball count
			...
			#
			require ("includes_pb/draw_count_table_2.incl"); #fix 1911
			##############################################################################
			...
			if ($limit > 105)
			{
				require ("includes_pb/unsorted_table_large_2.incl");
				#require ("includes/unsorted_table_1510.incl");
			} elseif ($limit == 100) {
				require ("includes_pb/unsorted_table_100_2.incl");
			} else {
				require ("includes_pb/unsorted_table_2.incl");
			}
			...
			if ($limit > 105 )
			{
				require ("includes_pb/sorted_table_large_2.incl");
			} elseif ($limit == 100) {
				require ("includes_pb/sorted_table_100_2.incl");
			} else {
				require ("includes_pb/sorted_table_2.incl");
			}
