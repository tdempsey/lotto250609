<?php
	...
	require ("includes/print_column_test_sumeo_range.php"); #200915
	...
	$sumeo = 5; ### <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
		...
		*/
		...
		for ($col = 1; $col <= 5; $col++)
		{
			print_column_test_sumeo_range($col, $sumeo_sum, $sumeo_even, $sumeo_odd,$range); #220812
		}
