<?php
	...
	{ 
		...
		print("<a name=\"$limit\"><H2>$game_name - Column $col Totals - combo_{$balls_drawn}_$balls</H2></a>\n");
	...
	{ 
		...
		print("<a name=\"$limit\"><H2>$game_name - Column $col Sum Totals - combo_{$balls_drawn}_$balls</H2></a>\n");
	...
	{ 
		...
		print("<a name=\"$limit\"><H2>$game_name - Col$cola/Col$colb Pairs Totals - combo_{$balls_drawn}_$balls</H2></a>\n");
	...
	print("<HTML>\n");
	print("<HEAD>\n");
	print("<TITLE>Lotto Column Summary - $game_name</TITLE>\n");
	print("</HEAD>\n");
